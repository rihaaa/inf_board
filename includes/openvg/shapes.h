...
extern void TextW(VGfloat, VGfloat, wchar_t *, Fontinfo, int);
extern void TextNew(VGfloat, VGfloat, int[], Fontinfo, int);
extern void TextMid(VGfloat, VGfloat, char *, Fontinfo, int);
extern void TextMidW(VGfloat, VGfloat, wchar_t *, Fontinfo, int);
extern void TextEnd(VGfloat, VGfloat, char *, Fontinfo, int);
extern void TextEndW(VGfloat, VGfloat, wchar_t *, Fontinfo, int);
